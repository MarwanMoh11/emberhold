...
export const QUESTS: QuestDef[] = [
  ...
  { id: 'a12', title: 'Timber hall', hint: 'Upgrade the Command Hall to level 2',
    goal: { type: 'upgrade', building: 'townHall', level: 2 }, reward: { coins: 340, stone: 150, xp: 80 } },
  { id: 'a13', title: 'Into the wood', hint: 'Claim Whisperwood',
    goal: { type: 'claim', region: 'whisperwood' }, reward: { coins: 250, wood: 400, xp: 60 } },
  { id: 'a14', title: 'The bridgehead', hint: 'Wall the Bridgehead: every piece and its gate',
    goal: { type: 'line', line: 'bridgehead' }, reward: { coins: 420, stone: 250, metal: 60, xp: 150 } },

  // ---- Act II · The River (waves 9–18) -----------------------------------
  { id: 'b1', title: 'Hollow', hint: 'Claim Hollow Village',
    goal: { type: 'claim', region: 'hollow' }, reward: { coins: 300, wood: 150, xp: 70 } },
  { id: 'b2', title: 'Rotwood burns', hint: 'Burn Rotwood Camp',
    goal: { type: 'burn', camp: 'campRotwood' }, reward: { coins: 380, wood: 200, stone: 100, xp: 90 } },
  { id: 'b3', title: 'Come up', hint: 'Find the survivors in the cellar under the green',
    goal: { type: 'reach', poi: 'survHollow' }, reward: { coins: 210, food: 200, xp: 60 } },
  { id: 'b4', title: 'A light in the dark', hint: 'Build an Outpost',
    goal: { type: 'build', building: 'outpost' }, reward: { coins: 300, wood: 150, xp: 70 } },
  { id: 'b5', title: 'The old roads', hint: 'Travel by waystone',
    goal: { type: 'travel' }, reward: { coins: 210, stone: 80, xp: 60 } },
  { id: 'b6', title: 'Greyfall', hint: 'Claim Greyfall Scarp',
    goal: { type: 'claim', region: 'greyfall' }, reward: { coins: 380, wood: 150, stone: 150, xp: 90 } },
  { id: 'b7', title: 'Good stone', hint: 'Build a Stone Quarry',
    goal: { type: 'build', building: 'quarry' }, reward: { coins: 425, stone: 250, xp: 100 } },
  { id: 'b8', title: 'Three fronts', hint: 'Survive night 14: the gorge is open now',
    goal: { type: 'survive', wave: 14 }, reward: { coins: 510, wood: 300, stone: 150, xp: 120 } },
  { id: 'b9', title: 'Over the bridge', hint: 'Claim the Ferrow Fields',
    goal: { type: 'claim', region: 'ferrow' }, reward: { coins: 470, food: 250, xp: 110 } },
  { id: 'b10', title: 'Break the muster', hint: 'Burn the Ferrow Muster',
    goal: { type: 'burn', camp: 'campFerrow' }, reward: { coins: 600, wood: 300, stone: 150, xp: 140 } },
  { id: 'b11', title: 'Full barns', hint: 'Build the Granary in the Ferrow Fields',
    goal: { type: 'build', building: 'granary', region: 'ferrow' }, reward: { coins: 380, food: 300, stone: 100, xp: 90 } },
  { id: 'b12', title: 'Stone hall', hint: 'Upgrade the Command Hall to level 3',
    goal: { type: 'upgrade', building: 'townHall', level: 3 }, reward: { coins: 680, wood: 600, stone: 300, metal: 60, xp: 160 } },
  { id: 'b13', title: 'Hold the ford', hint: 'Wall the Millford Barricade',
    goal: { type: 'line', line: 'millfordLine' }, reward: { coins: 850, stone: 400, metal: 100, xp: 200 } },
