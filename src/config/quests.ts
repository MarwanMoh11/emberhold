...
export const QUESTS: QuestDef[] = [
  ...
  { id: 'a1', title: 'Pick up the pieces', hint: 'Collect 30 coins from the wreckage',
    goal: { type: 'collect', resource: 'coins', amount: 30 }, reward: { coins: 20, xp: 5 } },
  { id: 'a2', title: 'First timber', hint: 'Build the Lumber Camp',
    goal: { type: 'build', building: 'lumberCamp' }, reward: { coins: 45, wood: 40, xp: 10 } },
  { id: 'a3', title: 'Hands to work', hint: 'Hire 2 workers at the Lumber Camp',
    goal: { type: 'workers', amount: 2 }, reward: { coins: 60, wood: 60, xp: 12 } },
  // Food has to exist before anything that costs food is asked for.
  { id: 'a4', title: 'Bread', hint: 'Build the Homestead Farm',
    goal: { type: 'build', building: 'farm' }, reward: { coins: 80, food: 110, xp: 18 } },
  { id: 'a5', title: 'Hold the bridge', hint: 'Survive the first night: it comes over the Old King\'s Bridge',
    goal: { type: 'survive', wave: 1 }, reward: { coins: 130, wood: 120, xp: 40 } },
  { id: 'a6', title: 'A roof', hint: 'Build the Longhouse',
    goal: { type: 'build', building: 'house' }, reward: { coins: 100, wood: 80, xp: 20 } },
  { id: 'a7', title: 'Steel', hint: 'Build the Barracks',
    goal: { type: 'build', building: 'barracks' }, reward: { coins: 90, food: 90, xp: 24 } },
  { id: 'a8', title: 'Muster', hint: 'Recruit 3 soldiers at the Barracks',
    goal: { type: 'recruit', amount: 3 }, reward: { coins: 120, food: 80, xp: 30 } },
  { id: 'a9', title: 'Stake a claim', hint: 'Claim the Barrow Downs at the North Gate',
    goal: { type: 'claim', region: 'downs' }, reward: { coins: 190, wood: 120, xp: 40 } },
  { id: 'a10', title: 'Dig them out', hint: 'Burn the Barrow Diggers\' camp',
    goal: { type: 'burn', camp: 'campDiggers' }, reward: { coins: 250, wood: 200, stone: 80, xp: 60 } },
  { id: 'a11', title: 'Hearths', hint: 'Build 2 cottages',
    goal: { type: 'build', building: 'cottage', amount: 2 }, reward: { coins: 140, wood: 120, xp: 30 } },
  { id: 'a12', title: 'Timber hall', hint: 'Upgrade the Command Hall to level 2',
    goal: { type: 'upgrade', building: 'townHall', level: 2 }, reward: { coins: 260, stone: 150, xp: 80 } },
  { id: 'a13', title: 'Into the wood', hint: 'Claim Whisperwood',
    goal: { type: 'claim', region: 'whisperwood' }, reward: { coins: 200, wood: 150, xp: 60 } },
  { id: 'a14', title: 'The bridgehead', hint: 'Wall the Bridgehead: every piece and its gate',
    goal: { type: 'line', line: 'bridgehead' }, reward: { coins: 350, stone: 250, metal: 60, xp: 150 } },

  // ---- Act II · The River (waves 9–18) -----------------------------------
  { id: 'b1', title: 'Hollow', hint: 'Claim Hollow Village',
    goal: { type: 'claim', region: 'hollow' }, reward: { coins: 200, wood: 150, xp: 70 } },
  { id: 'b2', title: 'Rotwood burns', hint: 'Burn Rotwood Camp',
    goal: { type: 'burn', camp: 'campRotwood' }, reward: { coins: 250, wood: 200, stone: 100, xp: 90 } },
  { id: 'b3', title: 'Come up', hint: 'Find the survivors in the cellar under the green',
    goal: { type: 'reach', poi: 'survHollow' }, reward: { coins: 140, food: 200, xp: 60 } },
  { id: 'b4', title: 'A light in the dark', hint: 'Build an Outpost',
    goal: { type: 'build', building: 'outpost' }, reward: { coins: 200, wood: 150, xp: 70 } },
  { id: 'b5', title: 'The old roads', hint: 'Travel by waystone',
    goal: { type: 'travel' }, reward: { coins: 140, stone: 80, xp: 60 } },
  { id: 'b6', title: 'Greyfall', hint: 'Claim Greyfall Scarp',
    goal: { type: 'claim', region: 'greyfall' }, reward: { coins: 250, wood: 150, stone: 150, xp: 90 } },
  { id: 'b7', title: 'Good stone', hint: 'Build a Stone Quarry',
    goal: { type: 'build', building: 'quarry' }, reward: { coins: 280, stone: 250, xp: 100 } },
  { id: 'b8', title: 'Three fronts', hint: 'The gorge is open now: light 2 Watch Posts over their roads',
    goal: { type: 'build', building: 'watchPost', amount: 2 }, reward: { coins: 340, wood: 300, stone: 150, xp: 120 } },
  { id: 'b9', title: 'Over the bridge', hint: 'Claim the Ferrow Fields',
    goal: { type: 'claim', region: 'ferrow' }, reward: { coins: 310, food: 250, xp: 110 } },
  { id: 'b10', title: 'Break the muster', hint: 'Burn the Ferrow Muster',
    goal: { type: 'burn', camp: 'campFerrow' }, reward: { coins: 400, wood: 300, stone: 150, xp: 140 } },
  { id: 'b11', title: 'Full barns', hint: 'Build the Granary in the Ferrow Fields',
    goal: { type: 'build', building: 'granary', region: 'ferrow' }, reward: { coins: 250, food: 300, stone: 100, xp: 90 } },
  { id: 'b12', title: 'Stone hall', hint: 'Upgrade the Command Hall to level 3',
    goal: { type: 'upgrade', building: 'townHall', level: 3 }, reward: { coins: 450, wood: 600, stone: 300, metal: 60, xp: 160 } },
  { id: 'b13', title: 'Hold the ford', hint: 'Wall the Millford Barricade',
    goal: { type: 'line', line: 'millfordLine' }, reward: { coins: 560, stone: 400, metal: 100, xp: 200 } },
  ...
  { id: 'c8', title: 'Old lights', hint: 'Restore 3 shrines',
    goal: { type: 'restore', amount: 3 }, reward: { coins: 1200, stone: 400, metal: 200, xp: 240 } },
