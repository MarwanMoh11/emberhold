...
export const PADS: PadBP[] = [
  ...
  P('cottageN1', 'cottage', 5010, 2390, 'hold', 1, 'Outside the North Gate, west of the King\'s Road: the first roof a Downs carter sees.'),
  P('cottageN2', 'cottage', 5240, 2420, 'hold', 1, 'Across the King\'s Road from its neighbour, under the north wall.'),
  P('cottageW2', 'cottage', 4060, 3040, 'hold', 1, 'West of the market, where the green runs out into the wood\'s edge.'),
  P('cottageW3', 'cottage', 4280, 2860, 'hold', 1, 'On the Wood Road below the chapel, the bell next door.'),
  P('cottageW4', 'cottage', 4400, 3290, 'hold', 1, 'Under the West Gate, where the West Road starts down to the green.'),
  P('cottageN3', 'cottage', 4910, 2500, 'hold', 2, 'The north wall\'s shadow, a second row once the hall is timber.'),
  P('cottageS1', 'cottage', 4860, 3940, 'hold', 2, 'Behind the bridgehead wall: the bridge-wardens\' house by the landing.'),
  ...
  P('cottageD1', 'cottage', 5160, 2290, 'downs', 1, 'The first cottage past the Downs stone, on the King\'s Road.'),
  P('cottageD2', 'cottage', 5010, 2260, 'downs', 1, 'Faces its neighbour across the King\'s Road, just past the stone.'),
  P('marketD', 'market', 5270, 2220, 'downs', 1, 'Barrowgate\'s market, the first stall a caravan meets out of the North Gate.'),
  P('granaryD', 'granary', 4980, 1970, 'downs', 1, 'Halfway up the King\'s Road, between the east and west loam farms.'),
  P('farmD1', 'farm', 4720, 2200, 'downs', 1, 'Loam below the barrow ridge, the nearest field to the hold.'),
  P('cottageD4', 'cottage', 4720, 2070, 'downs', 1, 'The farmstead\'s cottage, its back to the barrow ridge.'),
  P('millD', 'mill', 4960, 1790, 'downs', 1, 'A windmill on the rise between the three Downs farms.'),
  P('chapelD', 'chapel', 4960, 2140, 'downs', 2, 'Barrowgate\'s chapel, raised where the barrow ghosts are nearest the road.'),
  P('cottageD3', 'cottage', 4880, 2290, 'downs', 2, 'Barrowgate grows: another roof along the King\'s Road.'),
  P('watchD2', 'watchPost', 5080, 880, 'downs', 2, 'On the King\'s Road north of the Cross, a lamp toward the Diggers\' camp.'),
  ...
  P('cottageWw1', 'cottage', 4110, 2680, 'whisperwood', 1, 'Log cottage where the Wood Road leaves the hold\'s fields.'),
  P('cottageWw2', 'cottage', 4140, 2520, 'whisperwood', 1, 'Beside the Wood Road, roofed in shingle from the first clearing.'),
  P('millWw', 'mill', 3930, 2400, 'whisperwood', 1, 'The sawmill, a short drag from the edge-of-forest lumber camp.'),
  P('cottageWw3', 'cottage', 4080, 2810, 'whisperwood', 1, 'A sawyer\'s cottage, the saw heard from the door.'),
  P('lumberWw', 'lumberCamp', 3500, 1800, 'whisperwood', 1, 'Between two stands north of Woodcutters\' Rest.'),
  P('watchWw', 'watchPost', 2530, 1800, 'whisperwood', 1, 'On the old track, looking into the Deepwood.'),
  P('chapelWw', 'chapel', 4050, 2350, 'whisperwood', 2, 'A timber chapel in the clearing above the sawmill.'),
  P('cottageWw4', 'cottage', 4000, 2610, 'whisperwood', 2, 'The woodcutters\' hamlet fills out along the road.'),
  P('cottageWw5', 'cottage', 3300, 2020, 'whisperwood', 2, 'A cottage at Woodcutters\' Rest, for the crews who stay the week.'),
  ...
  P('cottageH1', 'cottage', 4080, 3490, 'hollow', 1, 'Hollow\'s east end, where the West Road comes down from the gate.'),
  P('cottageH2', 'cottage', 4070, 3330, 'hollow', 1, 'Across the West Road from the first, on the new green.'),
  P('chapelH', 'chapel', 3930, 3410, 'hollow', 1, 'The new green\'s chapel, the survivors\' first stone raised again.'),
  P('granaryH', 'granary', 3880, 3720, 'hollow', 1, 'Below the green, between the river farms and the fishery.'),
  P('millH', 'mill', 3100, 4230, 'hollow', 1, 'A watermill on the Emberflow, beside the river meadow farm.'),
  P('cottageH3', 'cottage', 4090, 3620, 'hollow', 1, 'The green\'s third cottage, facing the chapel.'),
  P('marketH', 'market', 3950, 3280, 'hollow', 2, 'The green\'s market, a day\'s trade from both greens.'),
  P('cottageH4', 'cottage', 2950, 4020, 'hollow', 2, 'The river meadow farmstead\'s cottage.'),
  ...
  P('cottageG1', 'cottage', 6410, 3120, 'greyfall', 2, 'Fieldstone cottage on the East Road, past the Greyfall stone.'),
  P('cottageG2', 'cottage', 6400, 2870, 'greyfall', 2, 'Scarpfoot\'s first row, built of the scarp\'s own stone.'),
  P('marketG', 'market', 6520, 2780, 'greyfall', 2, 'Scarpfoot\'s market on the East Road, where the quarry carts come down.'),
  P('cottageG3', 'cottage', 6620, 2600, 'greyfall', 2, 'Under the outpost, a quarryman\'s cottage.'),
  P('quarryG', 'quarry', 6630, 1900, 'greyfall', 2, 'Between the two faces, working both slides of loose stone.'),
  P('chapelG', 'chapel', 6700, 2820, 'greyfall', 3, 'A slate-roofed chapel below Scarpfoot\'s cliff.'),
  P('cottageG4', 'cottage', 6380, 3250, 'greyfall', 3, 'Scarpfoot spreads back toward the hold.'),
  P('watchG', 'watchPost', 7070, 2750, 'greyfall', 3, 'Over the gorge road, a lamp on the bridge the east raids cross.'),
  ...
  P('cottageF1', 'cottage', 5280, 4340, 'ferrow', 2, 'The first cottage off the Old King\'s Bridge.'),
  P('cottageF2', 'cottage', 5410, 4300, 'ferrow', 2, 'Faces its neighbour across the King\'s Road at the landing.'),
  P('granaryF', 'granary', 5000, 4520, 'ferrow', 2, 'At the bridge foot, a short haul from both floodplain farms.'),
  P('marketF', 'market', 5280, 4520, 'ferrow', 2, 'The landing market: floodplain grain for the hold\'s coin.'),
  P('millF1', 'mill', 4520, 4880, 'ferrow', 2, 'A windmill between the west floodplain farms.'),
  P('millF2', 'mill', 5710, 4940, 'ferrow', 2, 'A windmill on the Kettle Road, over the east farms.'),
  P('farmF1', 'farm', 5950, 4550, 'ferrow', 2, 'The east floodplain\'s far field, beside the Kettle Road.'),
  P('chapelF', 'chapel', 4910, 4420, 'ferrow', 3, 'The landing chapel, its bell heard on both banks.'),
  P('cottageF3', 'cottage', 5540, 4260, 'ferrow', 3, 'The landing village grows up the King\'s Road.'),
  P('cottageF4', 'cottage', 5950, 4420, 'ferrow', 3, 'The east farmstead\'s cottage.'),
  P('watchF', 'watchPost', 5520, 5620, 'ferrow', 3, 'On the Rim\'s edge, facing the Stair the south raids climb.'),
  ...
  P('cottageFm1', 'cottage', 6100, 780, 'frostmere', 3, 'Snow-roofed cottage on the Highroad, just past the Frostmere stone.'),
  P('cottageFm2', 'cottage', 6100, 930, 'frostmere', 3, 'Fieldstone and slate across the Highroad, its chimney always lit.'),
  P('chapelFm', 'chapel', 6210, 1000, 'frostmere', 3, 'A stone chapel below the Highroad, bell hung against the wind.'),
  P('cottageFm3', 'cottage', 6100, 650, 'frostmere', 3, 'The highland hamlet\'s third hearth, in the lee of the rise.'),
  P('farmFm', 'farm', 6350, 1150, 'frostmere', 3, 'Hardy barley on the sheltered slope under the hamlet.'),
  P('docksFm', 'docks', 7820, 1120, 'frostmere', 3, 'Jetties on the west shore beside the lake fishery, below Rimewatch.'),
  P('granaryFm', 'granary', 6230, 650, 'frostmere', 4, 'A stone granary above the hamlet, where the barley and lake fish keep.'),
  P('lumberFm', 'lumberCamp', 7620, 1570, 'frostmere', 4, 'The lower pinewood, below Rimewatch.'),
  P('watchFm', 'watchPost', 8150, 730, 'frostmere', 4, 'On the Highroad past Rimewatch, a lamp toward the isle and Hollowpeak.'),
  P('cottageFm4', 'cottage', 7500, 770, 'frostmere', 4, 'Rimewatch\'s first cottage, for the outpost\'s keepers.'),
  ...
  P('cottageSm1', 'cottage', 2510, 3960, 'saltmere', 3, 'Tar-boarded cottage on the salt road, past the Saltmere stone.'),
  P('cottageSm2', 'cottage', 2520, 4110, 'saltmere', 3, 'Reed-thatched, on stilts of fieldstone above the salt road\'s ditch.'),
  P('chapelSm', 'chapel', 2390, 4150, 'saltmere', 3, 'The salt road chapel, the harbour bells\' echo inland.'),
  P('cottageSm3', 'cottage', 2500, 3830, 'saltmere', 3, 'A saltmaker\'s cottage, nets drying at the door.'),
  P('farmSm', 'farm', 2400, 4280, 'saltmere', 3, 'Drained salt-marsh, the first dyke field of the farmstead.'),
  P('marketSm', 'market', 1100, 4250, 'saltmere', 3, 'The harbour market, between the quay and the outpost.'),
  P('docksSm', 'docks', 820, 4420, 'saltmere', 3, 'The harbour docks, beside the strand fishery and a short walk to the quay.'),
  P('cottageSm4', 'cottage', 2280, 4230, 'saltmere', 4, 'The salt-marsh farmstead\'s cottage.'),
  P('watchSm', 'watchPost', 1510, 5010, 'saltmere', 4, 'At Reedwater Ford, a lamp for the Coast Road.'),
  P('cottageSm5', 'cottage', 1250, 4170, 'saltmere', 4, 'A harbour cottage behind the outpost.'),
  ...
  P('cottageIt1', 'cottage', 7360, 2830, 'irontooth', 3, 'A miner\'s cottage at the Gorge Bridge\'s east foot.'),
  P('marketIt', 'market', 7650, 2960, 'irontooth', 3, 'The ore market at the bridge foot, where the carts wait to cross.'),
  P('cottageIt3', 'cottage', 7270, 2950, 'irontooth', 3, 'The bridge-foot hamlet\'s third miner\'s cottage.'),
  P('mineIt', 'mine', 8950, 3050, 'irontooth', 3, 'Open-cast iron on the south lip of the Irontooth seam.'),
  P('watchIt', 'watchPost', 7890, 3070, 'irontooth', 4, 'On the gorge road between the bridge and Rustgate.'),
  P('cottageIt4', 'cottage', 8250, 3020, 'irontooth', 4, 'Rustgate\'s first miners\' row.'),
  P('cottageIt5', 'cottage', 8370, 3100, 'irontooth', 4, 'Rustgate fills out behind the outpost.'),
  P('cottageIt2', 'cottage', 7410, 2950, 'irontooth', 3, 'Rust-iron roof on the East Road, across the bridge.'),
  P('chapelIt', 'chapel', 7620, 2730, 'irontooth', 3, 'A fieldstone chapel above the gorge, facing the hold.'),
  ...
  P('cottageBm1', 'cottage', 3240, 4780, 'barrowmoor', 3, 'Tarred cottage at the Millford\'s south bank, peat stacked by the door.'),
  P('cottageBm2', 'cottage', 3370, 4750, 'barrowmoor', 3, 'Turf-roofed, on the Mill Road past the ford.'),
  P('chapelBm', 'chapel', 3160, 4890, 'barrowmoor', 3, 'A chapel at the ford, for the moor\'s restless dead.'),
  P('granaryBm', 'granary', 3500, 4720, 'barrowmoor', 3, 'Above the ford, where the moor\'s grain meets the Mill Road.'),
  P('farmBm', 'farm', 2400, 5170, 'barrowmoor', 3, 'Moor barley on the only dry rise west of Gallowgate.'),
  P('cottageBm4', 'cottage', 2520, 5120, 'barrowmoor', 3, 'The moor farmstead\'s cottage.'),
  P('cottageBm3', 'cottage', 3330, 4880, 'barrowmoor', 4, 'The ford hamlet grows along the Mill Road.'),
  P('cottageBm5', 'cottage', 2960, 4910, 'barrowmoor', 4, 'A last cottage before the open moor.'),
  P('watchBm', 'watchPost', 2150, 5570, 'barrowmoor', 4, 'On the Coast Road west of Gallowgate, facing the Gallows Knight.'),
  ...
  P('cottageK1', 'cottage', 6340, 4840, 'kettle', 3, 'A basalt cottage on the Kettle Road, past the stone.'),
  P('cottageK2', 'cottage', 6330, 4680, 'kettle', 3, 'The spa hamlet\'s bathhouse keeper.'),
  P('chapelK', 'chapel', 6500, 4900, 'kettle', 3, 'The springs chapel, where the hurt come to the warm water.'),
  P('marketK', 'market', 6460, 4650, 'kettle', 3, 'The spa market, selling sulphur salts on the Kettle Road.'),
  P('cottageK3', 'cottage', 6350, 4970, 'kettle', 3, 'Ember-lit windows over the steaming road.'),
  P('quarryK', 'quarry', 6780, 5650, 'kettle', 4, 'Yellow sulphur stone from the west face.'),
  P('watchK', 'watchPost', 7290, 5220, 'kettle', 4, 'On the Kettle Road above the Pass, where the south-east muster climbs.'),
  P('cottageK4', 'cottage', 6500, 5100, 'kettle', 4, 'A spa cottage between the road and the springs.'),
  ...
  P('cottageDw1', 'cottage', 2120, 1600, 'deepwood', 3, 'A log lodge where the old track enters the Deepwood.'),
  P('cottageDw2', 'cottage', 2110, 1470, 'deepwood', 3, 'Moss on the eaves, antlers over the door.'),
  P('millDw', 'mill', 1950, 1510, 'deepwood', 3, 'A sawmill for the giant timber, on the track to Heartwood Lodge.'),
  P('chapelDw', 'chapel', 2130, 1770, 'deepwood', 3, 'A bark-roofed chapel under the first giant.'),
  P('cottageDw3', 'cottage', 2100, 1340, 'deepwood', 3, 'A woodward\'s lodge on the old track.'),
  P('lumberDw', 'lumberCamp', 1150, 2050, 'deepwood', 4, 'Between the two great stands west of Heartwood Lodge.'),
  P('watchDw', 'watchPost', 1300, 1150, 'deepwood', 4, 'Toward the Thornmother\'s den, past the Heart Oak.'),
  P('cottageDw4', 'cottage', 2140, 1900, 'deepwood', 4, 'The lodges grow along the track.'),
  ...
  P('cottageDv1', 'cottage', 8930, 4720, 'deepvein', 4, 'Basalt miners\' cottage just inside the Seamgate.'),
  P('cottageDv2', 'cottage', 9070, 4720, 'deepvein', 4, 'Iron-sheet roof on the Haul Road below the gate.'),
  P('marketDv', 'market', 8800, 4720, 'deepvein', 4, 'The seam market, where ore is weighed before the long haul north.'),
  P('granaryDv', 'granary', 9200, 4720, 'deepvein', 4, 'The miners\' camp\'s granary: nothing grows down here, everything is carried in.'),
  P('mineDv', 'mine', 8150, 5450, 'deepvein', 4, 'The western seam\'s north end, off the Haul Road.'),
  P('cottageDv3', 'cottage', 9330, 4690, 'deepvein', 5, 'The miners\' camp grows down the Haul Road.'),
  P('watchDv', 'watchPost', 9150, 4840, 'deepvein', 5, 'Inside the Seamgate, a brazier over the pass.'),
  ...
  P('cottageR1', 'cottage', 5190, 5820, 'rim', 4, 'Stairhead\'s first cottage, past the burned muster.'),
  P('cottageR2', 'cottage', 5340, 5810, 'rim', 4, 'Soot-roofed, on the King\'s Road above the Stair.'),
  P('chapelR', 'chapel', 5140, 5940, 'rim', 4, 'Stairhead\'s chapel, the last bell before the Crown.'),
  P('cottageR3', 'cottage', 5420, 6050, 'rim', 4, 'Beside Cinderwatch, for the Stair\'s wardens.'),
  P('cottageR4', 'cottage', 5470, 5800, 'rim', 5, 'Stairhead fills out behind the outpost.'),
  P('watchR1', 'watchPost', 5120, 6620, 'rim', 5, 'Over the Cinder Stair\'s west lip.'),
  P('watchR2', 'watchPost', 5420, 6610, 'rim', 5, 'Over the Cinder Stair\'s east lip.'),
  ...
  P('watchA1', 'watchPost', 3180, 6860, 'ashgate', 4, 'At the Bonepass\'s south mouth, the first lamp in the ash.'),
  P('cottageA1', 'cottage', 3310, 6860, 'ashgate', 4, 'A pass-foot cottage, basalt against the ashfall.'),
  P('cottageA2', 'cottage', 3440, 6860, 'ashgate', 4, 'Braziers at the door, on the Mill Road below the pass.'),
  P('marketA', 'market', 3500, 7170, 'ashgate', 4, 'Ashfall\'s market, in the fortress\'s lee.'),
  P('granaryA', 'granary', 3620, 7250, 'ashgate', 4, 'Ashfall\'s granary, stocked from the moor over the pass.'),
  P('cottageA3', 'cottage', 3370, 7300, 'ashgate', 4, 'Ashfall\'s first cottage by the outpost.'),
  P('watchA2', 'watchPost', 3280, 6990, 'ashgate', 5, 'Over the Bonepass, a second lamp on the pass road.'),
  P('chapelA', 'chapel', 3550, 7420, 'ashgate', 5, 'Ashfall\'s chapel, copper-green over the ash.'),
  P('mineA', 'mine', 1550, 7650, 'ashgate', 5, 'Black iron on the obsidian field\'s west lip.'),

  // ---- the Cinder Crown --------------------------------------------------------------------------------
  P('outCrown', 'outpost', 5400, 7350, 'crown', 5, 'Emberfall, at the foot of the Cinder Stair.'),
  P('towerC1', 'watchtower', 5800, 7200, 'crown', 5),
  P('cottageCr1', 'cottage', 5250, 6930, 'crown', 5, 'The first roof at the Cinder Stair\'s foot, ember-lit windows.'),
  P('cottageCr2', 'cottage', 5400, 6930, 'crown', 5, 'Basalt cottage below the Stair, on the King\'s Road to Emberfall.'),
  P('chapelCr', 'chapel', 5120, 6930, 'crown', 5, 'A copper-roofed chapel facing the caldera.'),
  P('cottageCr3', 'cottage', 5530, 6930, 'crown', 5, 'Emberfall reaches up the road to the Stair.'),
  P('watchCr1', 'watchPost', 4990, 6930, 'crown', 5, 'On the road in at the Stair\'s foot.'),
  P('cottageCr4', 'cottage', 5200, 7050, 'crown', 5, 'A cottage on the King\'s Road down to Emberfall.'),
  P('watchCr2', 'watchPost', 5950, 7050, 'crown', 5, 'On the caldera rim, watching the Stair maw.'),
  ...
  P('cottageCf2', 'cottage', 9180, 7900, 'cinderfall', 5, 'A smelter\'s cottage behind the outpost.'),
  P('cottageCf3', 'cottage', 9250, 8070, 'cinderfall', 5, 'Slagwatch grows along the Haul Road.'),
  P('delveCf', 'crystalDelve', 9450, 8650, 'cinderfall', 5, 'The crystal field\'s west edge, below the Forges.'),
  P('cottageCf1', 'cottage', 9410, 8020, 'cinderfall', 5, 'Slagwatch\'s first cottage, basalt on the slag.'),
  P('marketCf', 'market', 9130, 8020, 'cinderfall', 5, 'Slagwatch market: crystal and cinder iron for the hold.'),
  P('watchCf', 'watchPost', 8740, 7820, 'cinderfall', 5, 'Below the Ramp, west of the Haul Road, a brazier facing the Ramp maw.'),
]
...
export const CAMPS: CampBP[] = [
  { id: 'campDiggers', name: 'the Barrow Diggers', region: 'downs', x: 4600, y: 450, tier: 'warcamp', hp: 1800,
  ...
  { id: 'campFerrow', name: 'the Ferrow Muster', region: 'ferrow', x: 4750, y: 5700, tier: 'warcamp', hp: 4800,
  ...
  { id: 'campHollowpeak', name: 'Hollowpeak Den', region: 'frostmere', x: 9700, y: 500, tier: 'warcamp', hp: 6300,
  ...
  { id: 'campDrowned', name: 'the Drowned Bell', region: 'saltmere', x: 1800, y: 3450, tier: 'warcamp', hp: 6000,
  ...
  { id: 'campIrontooth', name: 'Irontooth Warcamp', region: 'irontooth', x: 9450, y: 2550, tier: 'warcamp', hp: 7200,
  ...
  { id: 'campGallows', name: 'Gallows Hill', region: 'barrowmoor', x: 1400, y: 6450, tier: 'stronghold', hp: 9000,
  ...
  { id: 'campKettle', name: 'Kettle Warcamp', region: 'kettle', x: 7200, y: 6250, tier: 'warcamp', hp: 6900,
  ...
  { id: 'campThornmother', name: 'the Thornmother\'s Den', region: 'deepwood', x: 900, y: 500, tier: 'stronghold', hp: 8200,
  ...
  { id: 'campOverseers', name: 'the Seam Overseers', region: 'deepvein', x: 8550, y: 6550, tier: 'stronghold', hp: 10500,
  ...
  { id: 'campStairwarden', name: 'the Stairwarden\'s Bastion', region: 'rim', x: 6000, y: 6450, tier: 'stronghold', hp: 11200,
  ...
  { id: 'campAshgate', name: 'Ashgate Fortress', region: 'ashgate', x: 2500, y: 8150, tier: 'fortress', hp: 18000,
  ...
  { id: 'campForges', name: 'the Slag Forges', region: 'cinderfall', x: 9650, y: 7450, tier: 'stronghold', hp: 13500,
