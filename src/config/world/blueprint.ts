...
export const PADS: PadBP[] = [
  ...
  P('cottageIt2', 'cottage', 7460, 2690, 'irontooth', 3, 'Rust-iron roof on the East Road, across the bridge.'),
  P('marketIt', 'market', 7650, 2960, 'irontooth', 3, 'The ore market at the bridge foot, where the carts wait to cross.'),
  P('chapelIt', 'chapel', 7580, 2640, 'irontooth', 3, 'A fieldstone chapel above the gorge, facing the hold.'),
